...
function getUser() {
  const u = sessionStorage.getItem('ET67User');
  return u ? JSON.parse(u) : null;
}

function logout() {
  sessionStorage.removeItem('ET67User');
...
function initSidebar() {
  ...
  if (user) {
    ...
    const rollEl = document.getElementById('sidebarUserRoll');
    if (nameEl) nameEl.textContent = user.name;
    if (rollEl) rollEl.textContent = 'রোল: ' + user.roll;
  }
}
...
const NOTIFICATIONS = [
  { id: 1, title: 'নতুন ফলাফল প্রকাশিত', desc: '৫ম সেমিস্টারের ফলাফল বোর্ডে প্রকাশ করা হয়েছে।', time: '২ ঘন্টা আগে', type: 'result', icon: '📊', unread: true },
  { id: 2, title: 'পরীক্ষার সময়সূচি', desc: 'ফাইনাল পরীক্ষার রুটিন ওয়েবসাইটে আপলোড করা হয়েছে।', time: '৫ ঘন্টা আগে', type: 'exam', icon: '📋', unread: true },
  ...
  { id: 4, title: 'ক্লাস বাতিল বিজ্ঞপ্তি', desc: 'আগামীকাল মেশিনারি ক্লাস বাতিল থাকবে।', time: '১ দিন আগে', type: 'notice', icon: '📢', unread: false },
  { id: 5, title: 'ফি পরিশোধের অনুরোধ', desc: 'সেমিস্টার ফি জমা দেওয়ার শেষ তারিখ ৩০ এপ্রিল।', time: '৩ দিন আগে', type: 'payment', icon: '💳', unread: false },
  { id: 6, title: 'বিজ্ঞান মেলার নিবন্ধন', desc: 'বার্ষিক বিজ্ঞান মেলায় অংশগ্রহণের জন্য নিবন্ধন করুন।', time: '১ সপ্তাহ আগে', type: 'event', icon: '🔬', unread: false },
];

const SYLLABUS = {
  'EET-501': {
    name: 'ইলেকট্রিক্যাল সার্কিট',
    topics: [
      { num: '০১', name: 'DC সার্কিট বিশ্লেষণ', desc: 'কির্চহফের সূত্র, নোড ও মেশ বিশ্লেষণ', done: true },
      ...
      { num: '০৫', name: 'ট্রানজিয়েন্ট অ্যানালাইসিস', desc: 'RC, RL, RLC ট্রানজিয়েন্ট রেসপন্স', done: false },
      { num: '০৬', name: 'ফোর্সড রেসপন্স', desc: 'AC স্টেডি স্টেট অ্যানালাইসিস', done: false },
    ]
  },
  'EET-503': {
    name: 'পাওয়ার সিস্টেম',
    topics: [
      { num: '০১', name: 'পাওয়ার সিস্টেম পরিচিতি', desc: 'জেনারেশন, ট্রান্সমিশন, ডিস্ট্রিবিউশন', done: true },
      { num: '০২', name: 'ট্রান্সফর্মার', desc: 'আদর্শ ও বাস্তব ট্রান্সফর্মার, দক্ষতা', done: true },
      { num: '০৩', name: 'ট্রান্সমিশন লাইন', desc: 'লাইন প্যারামিটার, লাইন মডেল', done: true },
      { num: '০৪', name: 'লোড ফ্লো অ্যানালাইসিস', desc: 'গাউস-সাইডেল, নিউটন-রাফসন মেথড', done: true },
      { num: '০৫', name: 'ফল্ট অ্যানালাইসিস', desc: 'সিমেট্রিক্যাল ও আনসিমেট্রিক্যাল ফল্ট', done: false },
      { num: '০৬', name: 'পাওয়ার সিস্টেম স্ট্যাবিলিটি', desc: 'স্ট্যাটিক ও ডায়নামিক স্ট্যাবিলিটি', done: false },
    ]
  }
};
...
window.ET67 = {
  login, getUser, logout, requireAuth,
  initSidebar, showToast,
  SUBJECTS, ATTENDANCE, RESULTS, ASSIGNMENTS, NOTIFICATIONS, SYLLABUS, STUDENTS_LIST
};
